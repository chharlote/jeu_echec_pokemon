...
public class Fenetre extends JFrame {
    ...
    /**
     * Construit une Fenetre ayant une zone d'affichage de 800x600 pixels et de titre "Mon appli src.MG2D".
     * <br /><br />
	...
	this.setTitle ( new String("Mon appli src.MG2D") );
	titre=new String("Mon appli src.MG2D");
