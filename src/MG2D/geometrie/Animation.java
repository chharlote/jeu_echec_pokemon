...
/*                     Guillaume Langa                               */
/*                                                                   */
/* This file is part of src.MG2D.                                        */
/* This library uses javazoom library piece of code                  */
/* http://www.javazoom.net                                           */
/* and can be found with this library (file jlayer1.0.1.tar.gz)      */
/*                                                                   */
/* src.MG2D is free software: you can redistribute it and/or modify      */
/* it under the terms of the GNU General Public License as published */
/* by the Free Software Foundation, either version 3 of the License, */
/* or (at your option) any later version.                            */
/*                                                                   */
/* src.MG2D is distributed in the hope that it will be useful,           */
/* but WITHOUT ANY WARRANTY; without even the implied warranty of    */
/* MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the      */
/* GNU General Public License for more details.                      */
/*                                                                   */
/* You should have received a copy of the GNU General Public License */
/* along with src.MG2D. If not, see <http://www.gnu.org/licenses/>.      */
/*                                                                   */
/*********************************************************************/

package src.MG2D.geometrie;

import src.MG2D.Couleur;
import java.awt.Graphics;

/**
 * Cette classe l'affichage d'images animées dans vos applications. Elle ne permet pas d'intégrer des gifs animés directement. Les images que vous voulez afficher doivent être dans un format supporté par src.MG2D (jpg, png, etc.). L'animation doit être un ensemble d'images dont le nom est composé d'une racine commune à toutes les images suivi d'un numéro. Par exemple, une nimation pourra être composée des images : "src.pokemons.img/perso1.png", "src.pokemons.img/perso2.png", ..., "src.pokemons.img/perso15.png". Ces informations (racine commune du nom de fichier, numéro de la première image, de la dernière, extension du fichier) vous eront nécessaires pour la création d'une animation lors de l'appel au contructeur. <br />
 * Les numéros de première et dernière image peuvent être écrit de manière classique ou formater de manière à ce que le nombre de caractère utilisé soit toujours constant. Exemple : "src.pokemons.img/perso001.png", "src.pokemons.img/perso002.png", ..., "src.pokemons.img/perso015.png". Dans ce cas, bien définir le numéro de première image à "001" et le numéro de dernière image à "015".<br />
